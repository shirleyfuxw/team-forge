...
| 3 | **Design** | multiple forge-design-agents (parallel; reciprocal review) | **One annotated `design.yaml`** — Phase 4 contract. Concrete roster, concrete skill discoveries from codebase + plugin search, comms patterns, escalation flow, rehydrate state declarations. Multi-agent review catches coverage issues, contradictions, missing fields. |
