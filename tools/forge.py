...
def resync_ledger_plan(design, hub_dir, do_write):
...
def resync(design, target_repo, team, basename, do_write):
    ...
    plan_delta = resync_ledger_plan(design, hub_dir, do_write)
